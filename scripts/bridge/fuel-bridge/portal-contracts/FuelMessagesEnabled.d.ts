...
interface FuelMessagesEnabledInterface extends ethers.utils.Interface {
  functions: {
...
export class FuelMessagesEnabled extends Contract {
  ...
  interface: FuelMessagesEnabledInterface;
