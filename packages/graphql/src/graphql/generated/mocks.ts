...
export const aBlocksDashboard = (overrides?: Partial<GQLBlocksDashboard>): { __typename: 'BlocksDashboard' } & GQLBlocksDashboard => {
    return {
        ...
        blockSize: overrides && overrides.hasOwnProperty('blockSize') ? overrides.blockSize! : '0xa',
        ...
        transactionsCount: overrides && overrides.hasOwnProperty('transactionsCount') ? overrides.transactionsCount! : '0xE',
    };
};
...
export const aRollingStats60s = (overrides?: Partial<GQLRollingStats60s>): { __typename: 'RollingStats60s' } & GQLRollingStats60s => {
    return {
        __typename: 'RollingStats60s',
        avgBlockSize: overrides && overrides.hasOwnProperty('avgBlockSize') ? overrides.avgBlockSize! : 7,
        avgGasPerBlock: overrides && overrides.hasOwnProperty('avgGasPerBlock') ? overrides.avgGasPerBlock! : 0.5,
        avgTxPerBlock: overrides && overrides.hasOwnProperty('avgTxPerBlock') ? overrides.avgTxPerBlock! : 2.9,
        peakTps: overrides && overrides.hasOwnProperty('peakTps') ? overrides.peakTps! : 7.6,
        tps: overrides && overrides.hasOwnProperty('tps') ? overrides.tps! : 8.4,
    };
};
