...
export const aContractSyncStatus = (overrides?: Partial<GQLContractSyncStatus>): { __typename: 'ContractSyncStatus' } & GQLContractSyncStatus => {
    return {
        __typename: 'ContractSyncStatus',
        errorMessage: overrides && overrides.hasOwnProperty('errorMessage') ? overrides.errorMessage! : 'sunt',
        fetchAttempts: overrides && overrides.hasOwnProperty('fetchAttempts') ? overrides.fetchAttempts! : 7589,
        firstSeen: overrides && overrides.hasOwnProperty('firstSeen') ? overrides.firstSeen! : 'at',
        lastUpdated: overrides && overrides.hasOwnProperty('lastUpdated') ? overrides.lastUpdated! : 'quam',
        status: overrides && overrides.hasOwnProperty('status') ? overrides.status! : 'quis',
    };
};
...
export const aSearchContract = (overrides?: Partial<GQLSearchContract>): { __typename: 'SearchContract' } & GQLSearchContract => {
    return {
        ...
        syncStatus: overrides && overrides.hasOwnProperty('syncStatus') ? overrides.syncStatus! : aContractSyncStatus(),
    };
};
