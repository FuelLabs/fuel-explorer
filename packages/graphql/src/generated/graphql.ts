...
type TransactionInput_InputContract_Fragment = {
  __typename: 'InputContract';
  contract: { __typename: 'Contract'; id: any };
};
...
type TransactionOutput_MessageOutput_Fragment = {
  __typename: 'MessageOutput';
  recipient: any;
  amount: any;
};
...
export type TransactionOutputFragment =
  ...
  | TransactionOutput_MessageOutput_Fragment
...
export type TransactionReceiptFragment = {
  ...
  recipient?: any | null;
  contractId?: any | null;
  contract?: { __typename: 'Contract'; id: any } | null;
  to?: { __typename: 'Contract'; id: any } | null;
};

export type TransactionItemFragment = {
  __typename: 'Transaction';
  id: any;
  title?: TransactionTitle | null;
  time?: string | null;
  ...
  gasPrice?: any | null;
  gasLimit?: any | null;
  inputAssetIds?: Array<any> | null;
  status?:
    | { __typename: 'FailureStatus'; time: any }
    | { __typename: 'SqueezedOutStatus' }
    | { __typename: 'SubmittedStatus'; time: any }
    | {
        __typename: 'SuccessStatus';
        time: any;
        block: { __typename: 'Block'; id: any };
    ...
    | null;
  inputContracts?: Array<{ __typename: 'Contract'; id: any }> | null;
  inputs?: Array<
    | {
        __typename: 'InputCoin';
        owner: any;
  ...
  > | null;
  outputs: Array<
    | { __typename: 'ChangeOutput'; to: any; amount: any; assetId: any }
    | { __typename: 'CoinOutput'; to: any; amount: any; assetId: any }
    | {
        __typename: 'ContractCreated';
        contract: { __typename: 'Contract'; id: any };
      }
    | { __typename: 'ContractOutput' }
    | { __typename: 'MessageOutput'; recipient: any; amount: any }
    | { __typename: 'VariableOutput'; to: any; amount: any; assetId: any }
  >;
  receipts?: Array<{
    __typename: 'Receipt';
    data?: any | null;
