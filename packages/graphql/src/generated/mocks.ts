import { Account, Balance, BalanceConnection, BalanceEdge, BalanceFilterInput, Block, BlockConnection, BlockEdge, ChainInfo, ChangeOutput, Coin, CoinConnection, CoinEdge, CoinFilterInput, CoinOutput, ConsensusParameters, Contract, ContractBalance, ContractBalanceConnection, ContractBalanceEdge, ContractBalanceFilterInput, ContractCreated, ContractOutput, ExcludeInput, FailureStatus, Genesis, Header, InputCoin, InputContract, InputMessage, Message, MessageConnection, MessageEdge, MessageOutput, MessageProof, Mutation, NodeInfo, PageInfo, PoAConsensus, ProgramState, Query, Receipt, SpendQueryElementInput, SqueezedOutStatus, SubmittedStatus, Subscription, SuccessStatus, TimeParameters, Token, Transaction, TransactionConnection, TransactionEdge, VariableOutput, CoinStatus, MessageStatus, ReceiptType, _ReturnType as ReturnType, TransactionStatusType, TransactionTitle } from './graphql';
...
export const aCoin = (overrides?: Partial<Coin>): { __typename: 'Coin' } & Coin => {
    return {
        ...
        status: overrides && overrides.hasOwnProperty('status') ? overrides.status! : CoinStatus.Spent,
...
export const aHeader = (overrides?: Partial<Header>): { __typename: 'Header' } & Header => {
    return {
        ...
        outputMessagesCount: overrides && overrides.hasOwnProperty('outputMessagesCount') ? overrides.outputMessagesCount! : 'cum',
        outputMessagesRoot: overrides && overrides.hasOwnProperty('outputMessagesRoot') ? overrides.outputMessagesRoot! : 'excepturi',
...
export const anInputMessage = (overrides?: Partial<InputMessage>): { __typename: 'InputMessage' } & InputMessage => {
    return {
        ...
        messageId: overrides && overrides.hasOwnProperty('messageId') ? overrides.messageId! : 'unde',
...
export const aMessage = (overrides?: Partial<Message>): { __typename: 'Message' } & Message => {
    return {
        ...
        messageId: overrides && overrides.hasOwnProperty('messageId') ? overrides.messageId! : 'est',
        ...
        status: overrides && overrides.hasOwnProperty('status') ? overrides.status! : MessageStatus.Spent,
    };
};
...
export const aMessageOutput = (overrides?: Partial<MessageOutput>): { __typename: 'MessageOutput' } & MessageOutput => {
    return {
        __typename: 'MessageOutput',
        amount: overrides && overrides.hasOwnProperty('amount') ? overrides.amount! : 'eaque',
        recipient: overrides && overrides.hasOwnProperty('recipient') ? overrides.recipient! : 'fugit',
    };
};
...
export const aMessageProof = (overrides?: Partial<MessageProof>): { __typename: 'MessageProof' } & MessageProof => {
    return {
        ...
        proofIndex: overrides && overrides.hasOwnProperty('proofIndex') ? overrides.proofIndex! : 'error',
        proofSet: overrides && overrides.hasOwnProperty('proofSet') ? overrides.proofSet! : ['aut'],
        ...
        signature: overrides && overrides.hasOwnProperty('signature') ? overrides.signature! : 'rerum',
    };
};
...
export const aQuery = (overrides?: Partial<Query>): { __typename: 'Query' } & Query => {
    return {
        ...
        resourcesToSpend: overrides && overrides.hasOwnProperty('resourcesToSpend') ? overrides.resourcesToSpend! : [[aCoin()]],
...
export const aReceipt = (overrides?: Partial<Receipt>): { __typename: 'Receipt' } & Receipt => {
    return {
        ...
        messageId: overrides && overrides.hasOwnProperty('messageId') ? overrides.messageId! : 'vero',
        ...
        rawPayload: overrides && overrides.hasOwnProperty('rawPayload') ? overrides.rawPayload! : 'et',
        ...
        receiptType: overrides && overrides.hasOwnProperty('receiptType') ? overrides.receiptType! : ReceiptType.Call,
...
export const aTimeParameters = (overrides?: Partial<TimeParameters>): TimeParameters => {
    return {
        blockTimeInterval: overrides && overrides.hasOwnProperty('blockTimeInterval') ? overrides.blockTimeInterval! : 'est',
        startTime: overrides && overrides.hasOwnProperty('startTime') ? overrides.startTime! : 'amet',
    };
};
...
export const aTransaction = (overrides?: Partial<Transaction>): { __typename: 'Transaction' } & Transaction => {
    return {
        ...
        time: overrides && overrides.hasOwnProperty('time') ? overrides.time! : 'quia',
