                ...
                receipts?: Array<{
                  ...
                  receipts?: Array<{
                    ...
                    item?: {
                      ...
                      subId?: string | null;
                      contract?: { __typename: 'Contract'; id: string } | null;
                      to?: { __typename: 'Contract'; id: string } | null;
                    } | null;
                  } | null> | null;
                  item?: {
                    __typename: 'Receipt';
...
export type TransactionContractItemFragment = {
  __typename: 'Contract';
  id: string;
};
...
export type TransactionItemFragment = {
  ...
  outputContract?: { __typename: 'ContractOutput'; inputIndex: number } | null;
  status?:
    | {
        __typename: 'FailureStatus';
        time: string;
  ...
  outputs: Array<
    ...
    | { __typename: 'ContractOutput'; inputIndex: number; balanceRoot: string }
    | {
        __typename: 'VariableOutput';
        to: string;
        amount: string;
