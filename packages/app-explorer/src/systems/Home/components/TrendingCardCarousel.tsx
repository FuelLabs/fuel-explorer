...
export const TrendingCardCarousel = () => {
  ...
  return (
    <div className="relative">
      ...
      {current < count && (
        <Button
          className="absolute z-10 top-1/2 -translate-y-1/2 translate-x-1/2 right-0 bg-gray-4 rounded-full w-8 h-8 p-0"
      ...
      {current > 1 && (
        <Button
          className="absolute z-10 top-1/2 -translate-y-1/2 -translate-x-1/2 left-0 bg-gray-4 rounded-full w-8 h-8 p-0"
