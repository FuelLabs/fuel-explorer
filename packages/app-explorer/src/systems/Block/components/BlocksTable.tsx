...
import { GridTable, HStack, Text, VStack, useBreakpoints } from '@fuels/ui';
      ...
      cell: (row: any) => {
        ...
        return (
          <Link
            ...
            href={`/block/${row.node.header.height}/simple`}
          >
            <div className="  sm:flex font-mono text-sm text-gray-contrast w-full flex justify-start pl-6 px-1">
              {mintTransaction
        ...
        return (
          ...
          >
            {!isMobile ? (
              ...
              <VStack gap={'0'} align={'end'} px={'4'}>
                <BlockTimeItem timeAgo={row.node.time.fromNow} />
                <HStack className="items-center" gap={'0.2'}>
                  <Text className="font-mono font-normal text-xs ">
                    Txn Count
                  </Text>
