...
import {
  ...
  i as dt,
  P as _r,
} from './hooks.module-fd12dd03.js';
const ae = 'Session currently connected',
  q = 'Session currently disconnected',
  pr = 'Session Rejected',
  gr = 'Missing JSON RPC response',
  mr = 'JSON-RPC success response must include "result" field',
  wr = 'JSON-RPC error response must include "error" field',
  yr = 'JSON RPC request must have valid "method" value',
  br = 'JSON RPC request must have valid "id" value',
  vr = 'Missing one of the required parameters: bridge / uri / session',
  Be = 'JSON RPC response format is invalid',
  Er = 'URI format is invalid',
  Sr = 'QRCode Modal not provided',
  We = 'User close QRCode Modal',
  Cr = [
    'session_request',
    'session_update',
    'exchange_key',
  ...
  ue = 'WALLETCONNECT_DEEPLINK_CHOICE',
  xr = { 1: 'mainnet', 3: 'ropsten', 4: 'rinkeby', 5: 'goerli', 42: 'kovan' };
var ht = ye;
ye.strict = ft;
ye.loose = _t;
...
const jt = 'https://registry.walletconnect.com';
function Fo() {
  return jt + '/api/v2/wallets';
}
function Ho() {
  return jt + '/api/v2/dapps';
}
...
(function (t) {
      ...
      case 'separator':
        return (a) => (u, c) =>
          c == null || c.length === 0
            ...
            : u.length === 0
              ? [[g(a, s), '=', g(c, s)].join('')]
              : [[u, g(c, s)].join(s.arrayFormatSeparator)];
      default:
        return (a) => (u, c) =>
          c === void 0 ||
          (s.skipNull && c === null) ||
  ...
  function f(s) {
    ...
    switch (s.arrayFormat) {
      ...
      case 'separator':
        return (u, c, h) => {
          const m = typeof c == 'string' && c.includes(s.arrayFormatSeparator),
            _ =
              typeof c == 'string' &&
              !m &&
              w(c, s).includes(s.arrayFormatSeparator);
          c = _ ? w(c, s) : c;
          const v =
            m || _
              ? c.split(s.arrayFormatSeparator).map((T) => w(T, s))
              : c === null
                ? c
                : w(c, s);
          h[u] = v;
  ...
  function R(s, a) {
    ...
    for (const h of Object.keys(c)) {
      ...
      if (typeof m == 'object' && m !== null)
        for (const _ of Object.keys(m)) m[_] = I(m[_], a);
      else c[h] = I(m, a);
    }
    return a.sort === !1
      ? c
  ...
  (t.extract = k),
    ...
    (t.stringify = (s, a) => {
      ...
      (a = Object.assign(
        ...
        p(a.arrayFormatSeparator);
      const u = (_) =>
          (a.skipNull && i(s[_])) || (a.skipEmptyString && s[_] === ''),
        c = d(a),
        h = {};
      for (const _ of Object.keys(s)) u(_) || (h[_] = s[_]);
      const m = Object.keys(h);
      return (
        a.sort !== !1 && m.sort(a.sort),
        m
          .map((_) => {
            const v = s[_];
            return v === void 0
    ...
    (t.parseUrl = (s, a) => {
      ...
      return Object.assign(
        { url: u.split('?')[0] || '', query: R(k(s), a) },
        a && a.parseFragmentIdentifier && c
          ? { fragmentIdentifier: w(c, a) }
          : {}
      );
    }),
    (t.stringifyUrl = (s, a) => {
      a = Object.assign({ encode: !0, strict: !0 }, a);
      const u = b(s.url).split('?')[0] || '',
        c = t.extract(s.url),
        h = t.parse(c, { sort: !1 }),
        m = Object.assign(h, s.query);
      let _ = t.stringify(m, a);
      _ && (_ = `?${_}`);
      let v = C(s.url);
      return (
        s.fragmentIdentifier && (v = `#${g(s.fragmentIdentifier, a)}`),
        `${u}${_}${v}`
      );
    }),
    (t.pick = (s, a, u) => {
      ...
      return t.stringifyUrl(
        { url: c, query: o(h, a), fragmentIdentifier: m },
        u
      );
    }),
    (t.exclude = (s, a, u) => {
...
function Qt(t) {
  ...
  function i(y) {
    const b = '@',
      C = y.split(b);
    return { handshakeTopic: C[0], version: parseInt(C[1], 10) };
  }
  const d = i(o),
    f = typeof n < 'u' ? t.substr(n) : '';
  function p(y) {
    const b = qe(y);
    return { key: b.key || '', bridge: b.bridge || '' };
  }
  const g = p(f);
...
function Vt(t) {
  return Cr.includes(t) || t.startsWith('wc_');
}
function Gt(t) {
...
class oi {
  constructor(e) {
    if (
      ...
      (this._netMonitor = e.netMonitor || new ni()),
...
const ci = 'walletconnect.org',
  li = 'abcdefghijklmnopqrstuvwxyz0123456789',
  Yt = li.split('').map((t) => `https://${t}.bridge.walletconnect.org`);
function ui(t) {
...
class gi {
  constructor(e) {
    if (
      ...
      (this._networkId = 0),
      (this._rpcUrl = ''),
      (this._eventManager = new si()),
      (this._clientMeta = de() || e.connectorOpts.clientMeta || null),
      (this._cryptoLib = e.cryptoLib),
      (this._sessionStorage =
        e.sessionStorage || new ai(e.connectorOpts.storageId)),
      ...
      throw new Error(vr);
    e.connectorOpts.bridge && (this.bridge = pi(e.connectorOpts.bridge)),
  ...
  async createSession(e) {
    if (this._connected) throw new Error(ae);
  ...
  rejectSession(e) {
    if (this._connected) throw new Error(ae);
    const n = e && e.message ? e.message : pr,
  ...
  updateSession(e) {
    if (!this._connected) throw new Error(q);
    (this.chainId = e.chainId),
      (this.accounts = e.accounts),
      (this.networkId = e.networkId || 0),
      (this.rpcUrl = e.rpcUrl || '');
  ...
  approveRequest(e) {
    ...
    } else throw new Error(mr);
  }
  rejectRequest(e) {
    if (z(e)) {
      const n = this._formatResponse(e);
      this._sendResponse(n);
    } else throw new Error(wr);
  }
  transportClose() {
  ...
  async _sendRequest(e, n) {
    const r = this._formatRequest(e),
      ...
      i = typeof n?.topic < 'u' ? n.topic : this.peerId,
      d = JSON.stringify(o),
      f =
        typeof n?.forcePushNotification < 'u'
  ...
  _formatRequest(e) {
    if (typeof e.method > 'u') throw new Error(yr);
    return {
  ...
  _formatResponse(e) {
    if (typeof e.id > 'u') throw new Error(br);
    ...
    } else if (P(e)) return Object.assign(Object.assign({}, n), e);
    throw new Error(Be);
  }
  _handleSessionDisconnect(e) {
    const n = e || 'Session Disconnected';
    this._connected || (this._qrcodeModal && this._qrcodeModal.close(), Me(ue)),
...
const Kt = 256,
  ...
  Si = 'verify';
function Ci(t) {
  return t === L ? { length: Zt, name: L } : { hash: { name: yi }, name: fe };
}
function ki(t) {
  return t === L ? [bi, vi] : [Ei, Si];
}
async function Ae(t, e = L) {
  return Q.getSubtleCrypto().importKey('raw', t, Ci(e), !0, ki(e));
}
async function xi(t, e, n) {
  const r = Q.getSubtleCrypto(),
    o = await Ae(e, L),
    i = await r.encrypt({ iv: t, name: L }, o, n);
  return new Uint8Array(i);
}
async function Ii(t, e, n) {
  const r = Q.getSubtleCrypto(),
    o = await Ae(e, L),
    i = await r.decrypt({ iv: t, name: L }, o, n);
  return new Uint8Array(i);
}
async function Ri(t, e) {
  const n = Q.getSubtleCrypto(),
    r = await Ae(t, fe),
    o = await n.sign({ length: wi, name: fe }, r, e);
...
class qi extends gi {
  constructor(e, n) {
    super({ cryptoLib: Li, connectorOpts: e, pushServerOpts: n });
  }
}
const Ai = et(ti);
var Ui = function () {
...
function ji(t, e) {
  ...
  try {
    (o = Pi()),
      ...
      f.addEventListener('copy', function (w) {
    ...
    if (!g) throw new Error('copy command was unsuccessful');
    p = !0;
  } catch (w) {
    n && console.error('unable to copy using execCommand: ', w),
      n && console.warn('trying IE specific stuff');
    try {
...
function rn(t, e) {
  function n(o) {
    var i = this.props.ref,
      d = i == o.ref;
    return (
      !d && i && (i.call ? i(null) : (i.current = null)),
      e ? !e(this.props, o) || !d : _e(this.props, o)
    );
  }
  function r(o) {
...
((X.prototype = new A()).isPureReactComponent = !0),
...
(S.unmount = function (t) {
  ...
  ((H.prototype = new A()).__c = function (t, e) {
    ...
    var f = function () {
      if (!--r.__u) {
        if (r.state.__a) {
          var p = r.state.__a;
          r.__v.__k[0] = cn(p, p.__c.__P, p.__c.__O);
        }
        var g;
  ...
  (H.prototype.render = function (t, e) {
    ...
    var o = e.__a && x($, null, t.fallback);
    return o && (o.__u &= -33), [x($, null, e.__a ? null : t.children), o];
  });
...
var hn =
  ...
  Ji = /^on(Ani|Tra|Tou|BeforeInp|Compo)/,
  Vi = /[A-Z0-9]/g,
...
S.event = function (t) {
  return (
    Ve && (t = Ve(t)),
    (t.persist = Ki),
    (t.isPropagationStopped = Zi),
    (t.isDefaultPrevented = Xi),
    (t.nativeEvent = t)
  );
};
var Ue,
  ...
  typeof t.type == 'string' &&
    (function (e) {
      ...
      for (var i in n) {
        ...
        if (
          !(
            (i === 'value' && 'defaultValue' in n && d == null) ||
            (Gi && i === 'children' && r === 'noscript') ||
            i === 'class' ||
            i === 'className'
          )
        ) {
                ...
                : f !== 'onchange' ||
                  ...
                  ? f === 'onfocus'
                    ...
                    : f === 'onblur'
                      ...
                      : Ji.test(i)
                        ? (i = f)
                        : r.indexOf('-') === -1 && Qi.test(i)
                          ? (i = i.replace(Vi, '-$&').toLowerCase())
                          : d === null && (d = void 0)
                  : (f = i = 'oninput'),
            f === 'oninput' && o[(i = f)] && (i = 'oninputCapture'),
            (o[i] = d);
        }
      }
      r == 'select' &&
        ...
        (o.value = O(n.children).forEach(function (p) {
          p.props.selected = o.value.indexOf(p.props.value) != -1;
        })),
        r == 'select' &&
          o.defaultValue != null &&
          (o.value = O(n.children).forEach(function (p) {
            p.props.selected = o.multiple
              ? o.defaultValue.indexOf(p.props.value) != -1
              : o.defaultValue == p.props.value;
          })),
        n.class && !n.className
          ? ((o.class = n.class), Object.defineProperty(o, 'className', es))
...
var E = Ai,
  ...
  l = os;
function ss(t) {
  On.toString(t, { type: 'terminal' }).then(console.log);
}
var as = `:root {
...
var ls =
  ...
  ds = 300,
  hs = 'rgb(64, 153, 255)',
  Nn = 'walletconnect-wrapper',
  Ze = 'walletconnect-style-sheet',
  Mn = 'walletconnect-qrcode-modal',
  fs = 'walletconnect-qrcode-close',
  Ln = 'walletconnect-qrcode-text',
  _s = 'walletconnect-connect-button';
function ps(t) {
  return l.createElement(
    ...
    l.createElement('p', null, us),
    l.createElement(
      'div',
      { className: 'walletconnect-modal__close__wrapper', onClick: t.onClose },
      l.createElement(
        'div',
        { id: fs, className: 'walletconnect-modal__close__icon' },
        l.createElement('div', {
...
function ys(t) {
  var e = t.color,
    ...
    o = t.logo,
    i = t.onClick,
    d = window.innerWidth < 768 ? (r.length > 8 ? 2.5 : 2.7) + 'vw' : 'inherit';
  return l.createElement(
    'a',
    {
...
function vs(t) {
  var e = E.isAndroid(),
    ...
    w = p[1],
    y = d
      ? t.links.filter(function (c) {
          return c.name.toLowerCase().includes(d.toLowerCase());
        })
      : t.links,
    b = t.errorMessage,
    C = d || y.length > bs,
    k = Math.ceil(y.length / le),
    I = [(g - 1) * le + 1, g * le],
    R = y.length
      ? y.filter(function (c, h) {
  ...
  return l.createElement(
    ...
    l.createElement(
      'p',
      { id: Ln, className: 'walletconnect-qrcode__text' },
      ...
      e
        ? l.createElement(gs, {
            ...
            onClick: l.useCallback(function () {
              E.saveMobileLinkInfo({ name: 'Unknown', href: t.uri });
            }, []),
          })
        : R.length
          ? R.map(function (c) {
              var h = c.color,
                ...
                _ = c.shortName,
                v = c.logo,
                T = E.formatIOSMobile(t.uri, c),
                U = l.useCallback(
                  function () {
                    E.saveMobileLinkInfo({ name: m, href: T });
                  },
                  [R]
                );
              return C
...
var Ss = function (t) {
  try {
    var e = '';
    return Promise.resolve(On.toString(t, { margin: 0, type: 'svg' })).then(
      function (n) {
        return (
          typeof n == 'string' &&
...
function Cs(t) {
  ...
  l.useEffect(function () {
    try {
      return Promise.resolve(Ss(t.uri)).then(function (p) {
        d(p);
      });
    } catch (p) {
      Promise.reject(p);
  ...
  return l.createElement(
    ...
    l.createElement('div', { dangerouslySetInnerHTML: { __html: i } }),
    l.createElement(
      'div',
      { className: 'walletconnect-modal__footer' },
      l.createElement('a', { onClick: f }, t.text.copy_to_clipboard)
    ),
    l.createElement(Es, { message: n })
  );
}
function ks(t) {
  var e = E.isAndroid(),
          ...
          var Pn = function () {
            try {
              ...
              var se = cs(
                function () {
                  ...
                  return Promise.resolve(fetch(F)).then(function (Dn) {
                    return Promise.resolve(Dn.json()).then(function ($n) {
                      var jn = $n.listings,
                        Bn = n ? 'mobile' : 'desktop',
                        G = E.getMobileLinkRegistry(
                          E.formatMobileRegistry(jn, Bn),
                          r
                        );
                      d(!1),
                        g(!0),
                        T(G.length ? '' : t.text.no_supported_wallets),
                        m(G);
                      var De = G.length === 1;
              ...
              return Promise.resolve(
                se && se.then ? se.then(function () {}) : void 0
              );
            } catch (F) {
  ...
  return l.createElement(
    'div',
    { id: Mn, className: 'walletconnect-qrcode__base animated fadeIn' },
    l.createElement(
      'div',
      { className: 'walletconnect-modal__base' },
      l.createElement(ps, { onClose: t.onClose }),
      a && y
        ? l.createElement(
            'div',
            ...
            l.createElement(
              ...
              {
                onClick: function () {
                  return E.saveMobileLinkInfo({ name: h[0].name, href: I });
                },
                href: I,
                rel: 'noopener noreferrer',
                target: '_blank',
              },
              t.text.connect_with + ' ' + (a ? h[0].name : '') + ' ›'
            )
          )
        : e || i || (!i && h.length)
          ? l.createElement(
      ...
      l.createElement(
        ...
        null,
        y || (!e && !i && !h.length)
          ? l.createElement(Cs, Object.assign({}, C))
          : l.createElement(
              vs,
              Object.assign({}, C, { links: h, errorMessage: v })
            )
      )
    )
  );
...
var xs = {
  ...
  Xe = { de: xs, en: Is, es: Rs, fr: Ts, ko: Os, pt: Ns, zh: Ms, fa: Ls };
function qs() {
  var t = E.getDocumentOrThrow(),
    e = t.getElementById(Ze);
...
class zs extends ur {
  ...
  async send(e) {
    (this.wc = this.register(this.opts)),
      ...
      this.sendPayload(e)
        ...
        .catch((n) => this.events.emit('payload', $e(e.id, n.message)));
  }
  register(e) {
    if (this.wc) return this.wc;
    (this.opts = e || this.opts),
      (this.bridge = e?.connector
        ? e.connector.bridge
        : e?.bridge || 'https://bridge.walletconnect.org'),
      (this.qrcode = typeof e?.qrcode > 'u' || e.qrcode !== !1),
      (this.chainId = typeof e?.chainId < 'u' ? e.chainId : this.chainId),
      (this.qrcodeModalOptions = e?.qrcodeModalOptions);
    const n = {
      bridge: this.bridge,
      qrcodeModal: this.qrcode ? Hs : void 0,
      qrcodeModalOptions: this.qrcodeModalOptions,
      storageId: e?.storageId,
      signingMethods: e?.signingMethods,
      clientMeta: e?.clientMeta,
    };
    if (
      ((this.wc = typeof e?.connector < 'u' ? e.connector : new qi(n)),
      typeof this.wc > 'u')
    )
  ...
  sanitizeResponse(e) {
    return typeof e.error < 'u' && typeof e.error.code > 'u'
      ? $e(e.id, e.error.message, e.error.data)
      : e;
  }
}
class Gs {
  constructor(e) {
    (this.events = new tt()),
      (this.rpc = { infuraId: e?.infuraId, custom: e?.rpc }),
      (this.signer = new je(new zs(e)));
    const n = this.signer.connection.chainId || e?.chainId || 1;
  ...
  async request(e) {
    ...
    if (we.includes(e.method)) return this.signer.request(e);
  ...
  setHttpProvider(e) {
    ...
    return typeof n > 'u' ? void 0 : new je(new dr(n));
  }
}
