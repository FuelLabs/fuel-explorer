import {
  ...
  p as H,
  y as ae,
} from './index-22d8af47.js';
import { bc as Ur } from './AccountConnectionInput-7bc330b7.js';
...
const yr = (t, e, r) => Math.min(Math.max(r, t), e),
  j = { duration: 0.3, delay: 0, endDelay: 0, repeat: 0, easing: 'ease' },
  Ye = (t) => typeof t == 'number',
  we = (t) => Array.isArray(t) && !Ye(t[0]),
  Zr = (t, e, r) => {
    const i = e - t;
    return ((((r - t) % i) + i) % i) + t;
  };
function zr(t, e) {
  return we(t) ? t[Zr(0, t.length, e)] : t;
}
const xr = (t, e, r) => -r * t + r * e + t,
  $r = () => {},
  G = (t) => t,
  Ut = (t, e, r) => (e - t === 0 ? 1 : (r - t) / (e - t));
function Cr(t, e) {
...
function Fr(t, e = Vr(t.length), r = G) {
  const i = t.length,
    o = i - e.length;
  return (
    o > 0 && Cr(e, o),
    (n) => {
      let a = 0;
      for (; a < i - 2 && !(n < e[a + 1]); a++);
      let s = yr(0, 1, Ut(e[a], e[a + 1], n));
      return (s = zr(r, a)(s)), xr(t[a], t[a + 1], s);
    }
  );
}
const Ar = (t) => Array.isArray(t) && Ye(t[0]),
  Rt = (t) => typeof t == 'object' && !!t.createAnimation,
...
function Yr(t, e, r, i, o) {
  let n,
    a,
    s = 0;
  do (a = e + (r - e) / 2), (n = _r(a, i, o) - t), n > 0 ? (r = a) : (e = a);
  while (Math.abs(n) > Kr && ++s < Qr);
  return a;
}
function Pe(t, e, r, i) {
  if (t === e && r === i) return G;
  const o = (n) => Yr(n, 0, 1, t, r);
  return (n) => (n === 0 || n === 1 ? n : _r(o(n), e, i));
}
const Gr =
    (t, e = 'end') =>
    (r) => {
...
function Ft(t) {
  ...
  if (t.startsWith('steps')) {
    ...
    if (e) {
      const r = e[1].split(',');
      return Gr(parseFloat(r[0]), r[1].trim());
    }
  }
  return G;
}
class Er {
  constructor(
    ...
    (this.repeat = s),
      (this.easing = we(i) ? G : Ft(i)),
      this.updateDuration(o);
    const $ = Fr(r, c, we(i) ? i.map(Ft) : G);
    (this.tick = (m) => {
      var _;
      n = n;
      let f = 0;
...
const Jr = (t) => new Or(typeof t == 'string' ? t : t + '', void 0, Bt),
  C = (t, ...e) => {
    const r =
      t.length === 1
        ? t[0]
...
const Ge = window,
  Qt = Ge.trustedTypes,
  to = Qt ? Qt.emptyScript : '',
  Yt = Ge.reactiveElementPolyfillSupport,
  Lt = {
    toAttribute(t, e) {
      switch (e) {
        case Boolean:
...
let ue = class extends HTMLElement {
  ...
  static finalize() {
    if (this.hasOwnProperty(Wt)) return !1;
    this[Wt] = !0;
  ...
  requestUpdate(e, r, i) {
    let o = !0;
    e !== void 0 &&
      (((i = i || this.constructor.getPropertyOptions(e)).hasChanged || kr)(
        this[e],
        r
      )
...
(ue[Wt] = !0),
  ...
  Yt == null || Yt({ ReactiveElement: ue }),
  ((rt = Ge.reactiveElementVersions) !== null && rt !== void 0
    ? rt
    : (Ge.reactiveElementVersions = [])
  ).push('1.6.3');
/**
 * @license
 * Copyright 2017 Google LLC
...
const Xe = window,
  ye = Xe.trustedTypes,
  Gt = ye ? ye.createPolicy('lit-html', { createHTML: (t) => t }) : void 0,
  Dt = '$lit$',
  ...
  Tr = Array.isArray,
  oo = (t) =>
    Tr(t) || typeof (t == null ? void 0 : t[Symbol.iterator]) == 'function',
  nt = `[ 	
\f\r]`,
...
\f\r"'\`<>=]|("|')|))|$)`,
  ...
  er = /'/g,
  tr = /"/g,
  Pr = /^(?:script|style|textarea|title)$/i,
  Mr =
    (t) =>
  ...
  for (let s = 0; s < r; s++) {
        ...
        a === Ce
          ? x[1] === '!--'
            ...
            : x[1] !== void 0
              ? (a = Jt)
              : x[2] !== void 0
                ? (Pr.test(x[2]) && (o = RegExp('</' + x[2], 'g')), (a = ee))
                : x[3] !== void 0 && (a = ee)
          : a === ee
            ? x[0] === '>'
              ? ((a = o ?? Ce), ($ = -1))
    ...
    n +=
      a === Ce
        ? c + ro
        : $ >= 0
          ? (i.push(d), c.slice(0, $) + Dt + c.slice($) + Q + _)
          : c + Q + ($ === -2 ? (i.push(void 0), s) : _);
  }
  return [Sr(t, n + (t[r] || '<?>') + (e === 2 ? '</svg>' : '')), i];
};
class Le {
  constructor({ strings: e, _$litType$: r }, i) {
    ...
    for (; (o = ie.nextNode()) !== null && c.length < s; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) {
          ...
          for (const m of o.getAttributeNames())
            if (m.endsWith(Dt) || m.startsWith(Q)) {
              const _ = x[a++];
              if (($.push(m), _ !== void 0)) {
                const f = o.getAttribute(_.toLowerCase() + Dt).split(Q),
                  u = /([.?@])?(.*)/.exec(_);
                c.push({
                  type: 1,
                  index: n,
        ...
        if (o.data === Ir) c.push({ type: 2, index: n });
        else {
          let $ = -1;
  ...
  return (
    (c == null ? void 0 : c.constructor) !== d &&
      ...
      i !== void 0
        ...
        : (r._$Cl = c)),
    c !== void 0 && (e = xe(t, c._$AS(t, e.values), c, i)),
    e
  );
}
class no {
    ...
    const { values: i, _$litType$: o } = e,
      n =
        typeof o == 'number'
          ? this._$AC(e)
          : (o.el === void 0 &&
              (o.el = Le.createElement(Sr(o.h, o.h[0]), this.options)),
            o);
    if (((r = this._$AH) === null || r === void 0 ? void 0 : r._$AD) === n)
      this._$AH.v(i);
    else {
      const a = new no(n, this),
        s = a.u(this.options);
...
let lo = class extends tt {
  ...
  j(e) {
    e && e !== P
      ? this.element.setAttribute(this.name, so)
      : this.element.removeAttribute(this.name);
  }
};
class co extends tt {
  ...
  _$AI(e, r = this) {
    var i;
    if ((e = (i = xe(this, e, r, 0)) !== null && i !== void 0 ? i : P) === le)
      return;
    const o = this._$AH,
      n =
        (e === P && o !== P) ||
...
or == null || or(Le, De),
  ((it = Xe.litHtmlVersions) !== null && it !== void 0
    ? it
    : (Xe.litHtmlVersions = [])
  ).push('2.8.0');
const mo = (t, e, r) => {
...
class w extends ue {
  ...
  update(e) {
    ...
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected),
      super.update(e),
      (this._$Do = mo(r, this.renderRoot, this.renderOptions));
  }
  connectedCallback() {
    var e;
...
function p(t) {
  return (e, r) => (r !== void 0 ? uo(t, e, r) : po(t, e));
}
/**
 * @license
 * Copyright 2017 Google LLC
...
function fo(t, e) {
  return t.has(e) || t.set(e, new Hr()), t.get(e);
}
const bo = ['', 'X', 'Y', 'Z'],
...
const ko = 0.015,
  Io = (t, e) => {
    ...
    for (let o = 0; o < i; o++) r += t(Ut(0, i - 1, o)) + ', ';
...
function Lo(t, e, r, i = {}, o) {
  ...
  const N = Nt(e),
    ...
    z = We.get(N);
  return (
    Wr(je.animation, !(Rt(m) && je.generator) && i.record !== !1),
    () => {
      const Ne = () => {
        var k, $e;
        return ($e =
      ...
      if (
        ...
        S && !ge.linearEasing() && (be(m) || (we(m) && m.some(be))) && (D = !1),
        D)
      ) {
        z && (T = T.map((J) => (Ye(J) ? z.toDefaultUnit(J) : J))),
        ...
        Ue.set(t, N, z && Ye(k) ? z.toDefaultUnit(k) : k);
      }
      return (
        a &&
          n(
    ...
    get: (t, e) => {
      ...
      switch (e) {
        ...
        case 'finished':
          return (
            t.finished ||
              (t.finished = Promise.all(t.animations.map(Ho)).catch($r)),
            t.finished
          );
        case 'stop':
          return () => {
...
let V = class extends w {
  ...
  render() {
    ...
    return (
      ...
      l`<button class="${Z(t)}" ?disabled="${this.disabled}" @click="${this.onClick}">${this.iconLeft}<wcm-text variant="small-regular" color="${e}"><slot></slot></wcm-text>${this.iconRight}</button>`
    );
  }
};
...
let He = class extends w {
  ...
  render() {
    ...
    return this.open
      ? l`<div class="${Z(r)}">${e === 'success' ? A.CHECKMARK_ICON : null} ${e === 'error' ? A.CROSS_ICON : null}<wcm-text variant="small-regular">${t}</wcm-text></div>`
      : null;
  }
};
    ...
    generate(t, e, r) {
      ...
      c.forEach(({ x: f, y: u }) => {
        ...
        for (let S = 0; S < c.length; S += 1) {
          const D = s * (B - S * 2);
          n.push(
            E`<rect fill="${S % 2 === 0 ? i : o}" height="${D}" rx="${D * M}" ry="${D * M}" width="${D}" x="${I + s * S}" y="${b + s * S}">`
          );
        }
      });
      ...
      return (
        ...
        Object.entries(_)
          ...
          .forEach(([f, u]) => {
            u.forEach(([I, b]) => {
              n.push(
                E`<line x1="${f}" x2="${f}" y1="${I}" y2="${b}" stroke="${i}" stroke-width="${s / (pr / 2)}" stroke-linecap="round">`
              );
            });
          }),
        n
...
let F = class extends w {
  ...
  svgTemplate() {
    ...
    return E`<svg height="${t}" width="${t}">${Ii.generate(this.uri, t, t / 4)}</svg>`;
  }
  render() {
...
let Ct = class extends w {
  ...
  render() {
    ...
    return l`<wcm-modal-header title="Connect your wallet" .onAction="${this.onGoToQrcode}" .actionIcon="${A.QRCODE_ICON}"></wcm-modal-header><wcm-modal-content><div class="wcm-title">${A.MOBILE_ICON}<wcm-text variant="small-regular" color="accent">WalletConnect</wcm-text></div><div class="wcm-slider"><div class="wcm-track">${[
      ...Array(r),
    ].map((i, o) => {
