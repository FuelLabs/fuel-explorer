import {
  ...
  i as ft,
  f as Jn,
} from './index-c457595d.js';
import { P as zr } from './index-8d47fad6.js';
import { g as mr, c as lt, a as Xn } from './_commonjsHelpers-de833af9.js';
import { d as Hn } from './index-356e4a49.js';
import { a as Qn } from './isPlainObject-0882b9c6.js';
import {
  _ as Yn,
  r as Kn,
  i as Zn,
...
import { R as at, r as ze } from './index-76fb7be0.js';
const es = [
  'a',
  'abbr',
  'address',
...
function ls() {
  return (
    ri ||
      ((ri = 1),
      (it.SourceMapGenerator = Ci().SourceMapGenerator),
      (it.SourceMapConsumer = os().SourceMapConsumer),
      (it.SourceNode = us().SourceNode)),
    it
  );
}
const cs = 'escodegen',
  hs = 'ECMAScript code generator',
  fs = 'http://github.com/estools/escodegen',
  ps = 'escodegen.js',
  ds = { esgenerate: './bin/esgenerate.js', escodegen: './bin/escodegen.js' },
  ms = ['LICENSE.BSD', 'README.md', 'bin', 'escodegen.js', 'package.json'],
  gs = '2.1.0',
  ys = { node: '>=6.0' },
  vs = [
    {
  ...
  xs = { type: 'git', url: 'http://github.com/estools/escodegen.git' },
  bs = { estraverse: '^5.2.0', esutils: '^2.0.2', esprima: '^4.0.1' },
  Ss = { 'source-map': '~0.6.1' },
  _s = {
    acorn: '^8.0.4',
    bluebird: '^3.4.7',
...
`),
    ...
    function Br(n, u) {
      var o, l, d, w, T, P, F, J, ce, qe, He, jr, qr, we;
        ...
        return (
          ...
          n.expression
            ? (u.push(v),
              ...
              u.push(o))
            : u.push(this.maybeBlock(n.body, kn)),
          u
        );
      }),
...
` && (d = ['{'])),
        ...
        DirectiveStatement: function (n, u) {
          return A.raw && n.raw
            ...
            : On(n.directive) + this.semicolon(u);
        },
...
` &&
    ...
    function Vn(n, u) {
      ...
      return (
        ...
        (A = u),
        x &&
          (e.browser ? (s = lt.sourceMap.SourceNode) : (s = ls().SourceNode)),
        (l = Dn(n)),
        x
    ...
    : e < 91
      ...
      : e < 97
        ...
        : e < 123
          ? !0
          : e <= 65535
            ? e >= 170 && Ts.test(String.fromCharCode(e))
            : t === !1
              ? !1
              : or(e, wi);
}
...
function Os(e) {
  ...
  return ii(t.onComment) && (t.onComment = Rs(t, t.onComment)), t;
}
function Rs(e, t) {
...
var ni = 0,
  ...
  re = function (t, r, i) {
    (this.options = t = Os(t)),
      ...
      (this.keywords = Ue(
        ws[t.ecmaVersion >= 6 ? 6 : t.sourceType === 'module' ? '5module' : 5]
      ));
    var s = '';
...
z.parseFunctionStatement = function (e, t, r) {
  return this.next(), this.parseFunction(e, ot | (r ? 0 : ur), !1, t);
};
...
z.parseTryStatement = function (e) {
  if (
    ...
    if ((this.next(), this.eat(h.parenL))) {
      ...
      this.enterScope(r ? Ni : 0),
        this.checkLVal(t.param, r ? Fi : Ne),
...
z.parseFunction = function (e, t, r, i) {
  this.initFunction(e),
    (this.options.ecmaVersion >= 9 || (this.options.ecmaVersion >= 6 && !i)) &&
      (this.type === h.star && t & ur && this.unexpected(),
      (e.generator = this.eat(h.star))),
    this.options.ecmaVersion >= 8 && (e.async = !!i),
    t & ot &&
      ((e.id = t & Bi && this.type !== h.name ? null : this.parseIdent()),
      e.id &&
        !(t & ur) &&
        this.checkLVal(
          e.id,
...
z.parseExport = function (e, t) {
  ...
  if (this.eat(h._default)) {
    ...
    if (this.type === h._function || (r = this.isAsyncFunction())) {
      ...
      this.next(),
        r && this.next(),
        (e.declaration = this.parseFunction(i, ot | Bi, !1, r));
...
z.parseImport = function (e) {
  return (
    this.next(),
    this.type === h.string
      ? ((e.specifiers = Bs), (e.source = this.parseExprAtom()))
    ...
    case 'Identifier':
      t === Ne &&
        ...
        r &&
          ...
          (r[e.name] = !0)),
        t !== ni && t !== Mi && this.declareName(e.name, t, e.start);
      break;
    case 'ChainExpression':
      this.raiseRecoverable(
        e.start,
...
W.parseMethod = function (e, t, r) {
  ...
  return (
    ...
    (this.awaitPos = 0),
    (this.awaitIdentPos = 0),
    this.enterScope(br(t, i.generator) | Li | (r ? Oi : 0)),
    this.expect(h.parenL),
...
W.parseFunctionBody = function (e, t, r) {
  ...
  if (i)
    ...
    (this.labels = []),
      ...
      this.strict && e.id && this.checkLVal(e.id, Mi),
...
De.declareName = function (e, t, r) {
  ...
  if (t === Ne) {
    ...
    for (var f = this.scopeStack.length - 1; f >= 0; --f) {
      ...
      if (
        (p.lexical.indexOf(e) > -1 && !(p.flags & Ni && p.lexical[0] === e)) ||
...
De.currentThisScope = function () {
  for (var e = this.scopeStack.length - 1; ; e--) {
    var t = this.scopeStack[e];
    if (t.flags & xr && !(t.flags & Pi)) return t;
  }
};
...
function Er(e) {
  var t = (Gi[e] = {
    binary: Ue(qs[e] + ' ' + si),
    nonBinary: { General_Category: Ue(si), Script: Ue(Gs[e]) },
  });
  ...
  Re = function (t) {
    (this.parser = t),
      ...
      (this.unicodeProperties =
        Gi[t.options.ecmaVersion >= 11 ? 11 : t.options.ecmaVersion]),
      (this.source = ''),
      (this.flags = ''),
      (this.start = 0),
      (this.switchU = !1),
...
j.regexp_eatCharacterClassEscape = function (e) {
  var t = e.current();
  if (Js(t)) return (e.lastIntValue = -1), e.advance(), !0;
...
j.regexp_eatClassAtom = function (e) {
  ...
  if (e.eat(92)) {
    ...
    if (e.switchU) {
      var r = e.current();
      (r === 99 || Hi(r)) && e.raise('Invalid class escape'),
        e.raise('Invalid escape');
    }
    e.pos = t;
  }
...
$.readRadixNumber = function (e) {
  ...
  return (
    ...
    this.options.ecmaVersion >= 11 && this.input.charCodeAt(this.pos) === 110
      ? ((r = Qi(this.input.slice(t, this.pos))), ++this.pos)
...
$.readNumber = function (e) {
  ...
  if (!r && !e && this.options.ecmaVersion >= 11 && i === 110) {
    var s = Qi(this.input.slice(t, this.pos));
    return (
      ++this.pos,
      Le(this.fullCharCodeAtPos()) &&
        this.raise(this.pos, 'Identifier directly after number'),
...
$.tryReadTemplateToken = function () {
  ...
  try {
    ...
    if (e === Yi) this.readInvalidTemplateToken();
    else throw e;
  }
  this.inTemplateElement = !1;
};
$.invalidStringToken = function (e, t) {
  if (this.inTemplateElement && this.options.ecmaVersion >= 9) throw Yi;
  this.raise(e, t);
};
...
var na = Yn,
  ...
  oa = '[object String]';
function ua(e) {
  return typeof e == 'string' || (!sa(e) && aa(e) && na(e) == oa);
}
var la = ua;
const ca = mr(la);
/*!
 ...
 */ var wr = Symbol.for('react.element'),
  ...
  ya = Symbol.for('react.server_context'),
...
var sn = function (t) {
  ...
  Tr = function e(t, r) {
    var i = r.displayName,
      s = i === void 0 ? Ia : i;
    if (typeof t == 'string') return sn(t);
    if (typeof t == 'number') return Ca(t);
    ...
    return ka && t.type === ze.Fragment ? wa(f, y) : Aa(a, c, p, y);
  };
function Na() {}
var La = function (t) {
    return t
...
`.concat(Pe(r + 1, i.tabStop), '$1')
  ...
  Fa = function (t, r, i, s) {
    ...
    if (typeof t == 'string') return '"'.concat(Ra(t), '"');
    if (ht(t) === 'symbol') {
      var a = t
        .valueOf()
        .toString()
    ...
    return typeof t == 'function'
      ...
      : ze.isValidElement(t)
        ...
        : t instanceof Date
          ...
          : ha(t) || Array.isArray(t)
            ? '{'.concat(Oa(t, r, i, s), '}')
            : '{'.concat(String(t), '}');
  },
  Ma = function (e, t, r, i, s, a, c, f) {
    if (!t && !i)
      throw new Error(
        'The prop "'.concat(
          e,
  ...
  Ba = function (e, t) {
    ...
    return (
      ...
      (i.type === 'string' || i.type === 'number')
        ? r.push(sn(String(i.value) + String(t.value)))
        : (i && r.push(i), r.push(t)),
      r
    );
  },
...
`)
  ...
  un = function (t, r, i, s, a) {
    return a ? Pe(i, s).length + r.length > a : t.length > 1;
  },
  za = function (t, r, i, s, a, c, f) {
    return (un(t, r, a, c, f) || i) && !s;
  },
  ln = function (e, t, r, i) {
    var s = e.type,
      a = e.displayName,
...
`),
  ...
  Ht = function (e, t, r, i) {
    ...
    if (e.type === 'string')
      return e.value ? ''.concat(Za(Ka(String(e.value)))) : '';
    if (e.type === 'ReactElement') return ln(e, t, r, i);
    if (e.type === 'ReactFragment') return Ha(e, t, r, i);
...
var hr = 'custom',
  ...
  tt = 'element';
function Pr(e) {
  return rs.includes(e.toLowerCase());
}
var cn = { format: { indent: { style: '  ' }, semicolons: !1 } },
  uo = { ...cn, format: { newline: '' } },
  lo = { ...cn };
function Me(e, t = !1) {
  return bi.generate(e, t ? uo : lo);
}
function fr(e, t = !1) {
  return t ? co(e) : Me(e);
}
...
function ho(e) {
  let t = Me(e);
  return t.endsWith('  }]') && (t = Hn(t)), t;
}
function fo(e) {
  let t = Me(e, !0);
  return t.startsWith('[    ') && (t = t.replace('[    ', '[')), t;
}
var hn = (e) => e.$$typeof === Symbol.for('react.memo'),
  po = (e) => e.$$typeof === Symbol.for('react.forward_ref'),
  Nr = { ...N, JSXElement: () => {} },
  mo = re.extend(ra());
function yt(e) {
...
function So(e) {
  ...
  return yt(t) === 'shape' ? pn(e.arguments[0]) : null;
}
function pn(e) {
  return { inferredType: { type: 'Object', depth: fn(e) }, ast: e };
}
function _o(e) {
  return { inferredType: { type: 'Array', depth: fn(e) }, ast: e };
}
function Eo(e) {
  switch (e.type) {
    case 'Identifier':
...
function Co(e) {
  let t = mo.parse(`(${e})`, { ecmaVersion: 2020 }),
    r = { inferredType: { type: 'Unknown' }, ast: t };
  if (t.body[0] != null) {
    let i = t.body[0];
    switch (i.type) {
      case 'ExpressionStatement': {
        let s = Eo(i.expression);
        s != null && (r = s);
        break;
      }
    }
...
function mn(e, t) {
  ...
  switch (s) {
    ...
    case 'Array': {
      let { depth: p } = r;
      (a = Ir), (c = p <= 2 ? gi(i, !0) : null), (f = gi(i));
      break;
    }
    default:
      (a = wo(s)), (c = mi(e).length === 1 ? e : null), (f = e);
      break;
  }
...
function ko({ raw: e }) {
  return e != null
    ? mn(e, 'custom')
    : de({ name: 'custom', short: hr, compact: hr });
}
function To(e) {
  let { jsDocTags: t } = e;
  return t != null && (t.params != null || t.returns != null)
    ? de({
        name: 'func',
        short: so(t.params, t.returns),
        compact: null,
        full: no(t.params, t.returns),
      })
...
function Lo({ value: e, computed: t }) {
  return t
    ? mn(e, 'enumvalue')
...
function Oo(e) {
  if (Array.isArray(e.value)) {
    let t = e.value.reduce(
      (r, i) => {
        let { short: s, compact: a, full: c } = Lo(i);
...
function Ro(e, t) {
  ...
  return de({ name: 'arrayOf', short: pr(i), compact: pr(i) });
}
function Ze(e, t) {
  try {
    switch (e.name) {
  ...
  try {
    switch (t.name) {
      ...
      case 'arrayOf': {
        ...
        return i != null && !Jn(i) ? te(i) : s ? te(r, s) : te(r);
      }
      case 'func': {
        let { short: r, full: i } = Ze(t, e),
          s = r,
          a;
        return i && i.length < Ao ? (s = i) : i && (a = ao(i)), te(s, a);
      }
      default:
        return null;
    }
...
function Mo({ inferredType: e, ast: t }) {
  let { identifier: r } = e;
  if (r != null) return te(vn(e), Me(t));
  let i = Me(t, !0);
...
var jo = (e) => {
    if (bn(e) && e.type != null) return Vo(e);
    if (Qn(e)) {
  ...
  Uo = (e) => te(e.toString()),
  _n = { string: Do, object: jo, function: qo, default: Uo };
function Go(e = {}) {
  return { ..._n, ...e };
}
function En(e, t, r = _n) {
  try {
    switch (typeof e) {
      case 'string':
        return r.string(e, t);
...
function Xo(e, t) {
  let r = t.defaultProps != null ? t.defaultProps : {},
    i = e.map((s) => Jo(s, r[s.propDef.name]));
  return zo(i, t);
}
function Ho(e, t) {
  let { propDef: r } = e,
...
function Yo(e, t) {
  let r = e;
  !Wn(e) && !e.propTypes && hn(e) && (r = e.type);
  let i = $n(r, t);
...
var eu = (e, t) => {
      ...
      ...(typeof t.displayName == 'string'
        ...
        : {
            displayName: (a) =>
              ...
              zn(a.type, 'displayName') ||
              (a.type.name !== '_default' ? a.type.name : null) ||
              (typeof a.type == 'function' ? 'No Display Name' : null) ||
              (po(a.type) ? a.type.render.name : null) ||
              (hn(a.type) ? a.type.type.name : null) ||
              a.type,
          }),
    ...
    return at.Children.map(e, (a) => {
      let c = typeof a == 'number' ? a.toString() : a,
        f = (typeof ut == 'function' ? ut : ut.default)(dr(c), s);
      if (f.indexOf('&quot;') > -1) {
        let p = f.match(/\S+=\\"([^"]*)\\"/g);
        p &&
          p.forEach((y) => {
...
`
  ...
  tu = { skip: 0, showFunctions: !1, enableBeautify: !0, showDefaultProps: !1 },
  ru = (e) => {
    var i;
    let t =
  ...
  Cn = (e) => {
    ...
    let { mdxType: t, originalType: r, children: i, ...s } = e.props,
      a = [];
    return (
      i && (a = (Array.isArray(i) ? i : [i]).map(Cn)),
      ze.createElement(r, s, ...a)
    );
  },
  An = (e, t) => {
    var g, b;
    ...
    io(() => {
      if (!i) {
        ...
        r.emit(Gn, { id: E, source: s, args: S });
      }
    });
    let a = e();
    if (i) return a;
    let c = { ...tu, ...((t == null ? void 0 : t.parameters.jsx) || {}) },
      f =
        (b =
