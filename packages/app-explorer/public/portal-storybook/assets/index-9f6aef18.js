...
import { g as pe, a as tt } from './_commonjsHelpers-de833af9.js';
import {
  b as A,
  l as C,
  y as x,
...
const ae = 'Session currently connected',
  ...
  pr = 'Session Rejected',
  mr = 'Missing JSON RPC response',
  gr = 'JSON-RPC success response must include "result" field',
  wr = 'JSON-RPC error response must include "error" field',
  br = 'JSON RPC request must have valid "method" value',
  yr = 'JSON RPC request must have valid "id" value',
...
(function (t) {
      ...
      case 'separator':
        return (a) => (u, c) =>
          c == null || c.length === 0
            ...
            : u.length === 0
              ? [[m(a, s), '=', m(c, s)].join('')]
              : [[u, m(c, s)].join(s.arrayFormatSeparator)];
      default:
        return (a) => (u, c) =>
          c === void 0 ||
          (s.skipNull && c === null) ||
  ...
  function f(s) {
    ...
    switch (s.arrayFormat) {
      ...
      case 'separator':
        return (u, c, h) => {
          const g = typeof c == 'string' && c.includes(s.arrayFormatSeparator),
            _ =
              typeof c == 'string' &&
              !g &&
  ...
  function R(s, a) {
    ...
    for (const h of s.split('&')) {
      if (h === '') continue;
      let [g, _] = r(a.decode ? h.replace(/\+/g, ' ') : h, '=');
      (_ =
        _ === void 0
          ? null
    ...
    for (const h of Object.keys(c)) {
      ...
      if (typeof g == 'object' && g !== null)
        for (const _ of Object.keys(g)) g[_] = I(g[_], a);
      else c[h] = I(g, a);
    }
    return a.sort === !1
      ? c
  ...
  (t.extract = k),
    ...
    (t.stringifyUrl = (s, a) => {
      ...
      const u = y(s.url).split('?')[0] || '',
        c = t.extract(s.url),
        h = t.parse(c, { sort: !1 }),
        g = Object.assign(h, s.query);
      let _ = t.stringify(g, a);
      _ && (_ = `?${_}`);
      let v = S(s.url);
      return (
        s.fragmentIdentifier && (v = `#${m(s.fragmentIdentifier, a)}`),
        `${u}${_}${v}`
      );
    }),
    (t.pick = (s, a, u) => {
      u = Object.assign({ parseFragmentIdentifier: !0 }, u);
      const { url: c, query: h, fragmentIdentifier: g } = t.parseUrl(s, u);
      return t.stringifyUrl(
        { url: c, query: o(h, a), fragmentIdentifier: g },
        u
      );
    }),
    (t.exclude = (s, a, u) => {
      const c = Array.isArray(a) ? (h) => !a.includes(h) : (h, g) => !a(h, g);
      return t.pick(s, c, u);
    });
})(Le);
function Wt(t) {
...
function Qt(t) {
  ...
  function i(b) {
    const y = '@',
      S = b.split(y);
    return { handshakeTopic: S[0], version: parseInt(S[1], 10) };
  }
  const d = i(o),
    f = typeof n < 'u' ? t.substr(n) : '';
  function p(b) {
    const y = qe(b);
    return { key: y.key || '', bridge: y.bridge || '' };
  }
  const m = p(f);
  return Object.assign(Object.assign({ protocol: r }, d), m);
}
function Qo(t) {
...
class mi {
  ...
  async connect(e) {
    if (!this._qrcodeModal) throw new Error(Cr);
  ...
  _formatRequest(e) {
    if (typeof e.method > 'u') throw new Error(br);
    return {
  ...
  _formatResponse(e) {
    if (typeof e.id > 'u') throw new Error(yr);
...
const Kt = 256,
  ...
  Ci = 'verify';
function Si(t) {
  return t === L ? { length: Zt, name: L } : { hash: { name: bi }, name: fe };
}
function ki(t) {
  return t === L ? [yi, vi] : [Ei, Ci];
}
      ...
      f.addEventListener('copy', function (w) {
        if ((w.stopPropagation(), e.format))
          if ((w.preventDefault(), typeof w.clipboardData > 'u')) {
            ...
            var b = Fe[e.format] || Fe.default;
            window.clipboardData.setData(b, t);
          } else
...
function vs(t) {
  var e = E.isAndroid(),
    ...
    y = t.errorMessage,
    S = d || b.length > ys,
    k = Math.ceil(b.length / le),
    I = [(m - 1) * le + 1, m * le],
    R = b.length
      ? b.filter(function (c, h) {
        ...
        : R.length
          ? R.map(function (c) {
              var h = c.color,
                ...
                U = l.useCallback(
                  function () {
                    E.saveMobileLinkInfo({ name: g, href: T });
                  },
                  [R]
                );
              return S
                  ...
                  return Promise.resolve(fetch(F)).then(function (Dn) {
                    return Promise.resolve(Dn.json()).then(function ($n) {
                      ...
                      d(!1),
                        ...
                        g(G);
                      var De = G.length === 1;
                      De && (R(E.formatIOSMobile(t.uri, G[0])), y(!0)), u(De);
                    });
                  });
                },
                function (F) {
  ...
  return l.createElement(
    ...
    l.createElement(
      ...
      l.createElement(
        ...
        null,
        b || (!e && !i && !h.length)
          ? l.createElement(Ss, Object.assign({}, S))
          : l.createElement(
              vs,
              Object.assign({}, S, { links: h, errorMessage: v })
            )
      )
    )
  );
