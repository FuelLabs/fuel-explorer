import { d as O } from './index-356e4a49.js';
import { v as g } from './v4-4a60fe23.js';
...
const { addons: A } = __STORYBOOK_MODULE_PREVIEW_API__,
  { global: u } = __STORYBOOK_MODULE_GLOBAL__;
var P = 'storybook/actions',
  V = `${P}/action-event`,
  D = { depth: 10, clearOnStoryChange: !0, limit: 50 },
  h = (t, e) => {
    let r = Object.getPrototypeOf(t);
    return !r || e(r) ? r : h(r, e);
  },
  S = (t) =>
    !!(
      typeof t == 'object' &&
      t &&
      h(t, (e) => /^Synthetic(?:Base)?Event$/.test(e.constructor.name)) &&
  ...
  let r = { ...D, ...e },
    o = function (...i) {
      ...
      if (e.implicit) {
        let l =
          (d =
            '__STORYBOOK_PREVIEW__' in u ? u.__STORYBOOK_PREVIEW__ : void 0) ==
          null
            ? void 0
            : d.storyRenders.find(
        ...
        if (l) {
          let a = !(
              (p = window == null ? void 0 : window.FEATURES) != null &&
              p.disallowImplicitActionsInRenderV8
            ),
            _ = new y({ phase: l.phase, name: t, deprecated: a });
          if (a) console.warn(_);
          else throw _;
        }
      }
...
var m = (t, e) => typeof e[t] > 'u' && !(t in e),
  M = (t) => {
    ...
    return Object.entries(r)
      .filter(([E]) => !!n.test(E))
      .reduce(
        (E, [s, R]) => (m(s, e) && (E[s] = c(s, { implicit: !0, id: o })), E),
        {}
      );
  },
  j = (t) => {
    ...
    return (o != null && o.disable) || !r
      ? {}
      : Object.entries(r)
          .filter(([i, n]) => !!n.action)
          .reduce(
            (i, [n, E]) => (
              m(n, e) && (i[n] = c(typeof E.action == 'string' ? E.action : n)),
              i
            ),
            {}
          );
  ...
  w = (t) => {
    ...
    (r != null && r.disable) ||
      Object.entries(e)
        ...
        .forEach(([o, i]) => {
          let n = i.getMockImplementation();
          if (
            (n == null ? void 0 : n._actionAttached) !== !0 &&
            (n == null ? void 0 : n.isAction) !== !0
          ) {
            let E = (...s) => (c(o)(...s), n == null ? void 0 : n(...s));
            (E._actionAttached = !0), i.mockImplementation(E);
          }
        });
  },
  x = [w];
export { L as argsEnhancers, x as loaders };
