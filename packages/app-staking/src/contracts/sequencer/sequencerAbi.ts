export const sequencerAbi = [
  ...
  },
  {
    inputs: [
      {
        internalType: 'string',
        name: 'newTokenDenomination',
        type: 'string',
      },
    ],
    name: 'setTokenDenomination',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
