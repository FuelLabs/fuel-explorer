...
/**
 * IconRig - The Rig brand mark icon
 * Extracted from @fuels/ui-icons to avoid dependency
 */
export const IconRig = ({ size = 24, className }: IconRigProps) => {
  return (
    <svg
      width={size}
      height={size}
