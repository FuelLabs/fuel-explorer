...
export const styles = tv({
  slots: {
    ...
    menu: [
      ...
      'not-first:border-t not-first:border-gray-8 desktop:not-first:border-t-0 border-t-0',
    ],
    menuItem: [
    ...
    themeToggle: [
      'relative cursor-pointer flex items-center px-2 w-12 h-8 rounded-full border-gray-8',
    ...
    desktopWrapper: ['border-b border-gray-8 min-h-[var(--nav-height)]'],
    mobileWrapper: [
      'pl-3 pr-2 border-b border-gray-8 min-h-[var(--nav-height)]',
    ],
    ...
    mobileContent: [
      ...
      'min-h-[var(--nav-height)] data-[open=true]:border-b data-[open=true]:border-gray-8',
      'fuel-[NavLogo]:flex-1',
