export const contract = {
  ...
  abi: [
    ...
    {
      inputs: [],
      name: 'AmountPrecisionIncompatibility',
      type: 'error',
    },
    {
      inputs: [],
    ...
    {
      inputs: [],
      name: 'CurrentMessageSenderNotSet',
      type: 'error',
    },
    {
      inputs: [],
    ...
    {
      inputs: [],
      name: 'InvalidBlockInHistoryProof',
      type: 'error',
    },
    {
      inputs: [],
      name: 'InvalidMessageInBlockProof',
      type: 'error',
    },
    {
      inputs: [],
    ...
    {
      inputs: [],
      name: 'getNextOutgoingMessageNonce',
      outputs: [
        {
          internalType: 'uint256',
          name: '',
      ...
      inputs: [
        ...
        },
        {
          components: [
            ...
            {
              internalType: 'uint32',
              name: 'stateTransitionBytecodeVersion',
              type: 'uint32',
            },
            {
              internalType: 'uint32',
    ...
    },
    {
      ...
      name: 'removeMessageFromBlacklist',
      outputs: [],
      stateMutability: 'payable',
      type: 'function',
    },
    ...
    },
    {
      inputs: [
        {
          internalType: 'address',
          name: 'newFuelChainState',
          type: 'address',
        },
      ],
      name: 'setFuelChainState',
      outputs: [],
      stateMutability: 'nonpayable',
      type: 'function',
    },
  ...
  transactionHash:
    '0xaaa628d33a2247ea28a9db05472e879c8aa63689a2561c947dfc8facac06ce11',
  numDeployments: 4,
  linkedData: {
  ...
  implementation: '0x2C4df10a82CF077122eD99573acA6daCd76F2E67',
};
