...
async function main() {
  ...
  // Only the archive path decodes protobuf; the rpc loader already gets
  // GQL-shaped blocks from the node. process.exit in shutdown below ends the
  // worker threads with the process.
  const pool =
